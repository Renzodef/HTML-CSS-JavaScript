...
## CSS
It contains all the personal examples and material related to CSS (Cascading Style Sheets).
...
## JavaScript
It contains examples of the basic functions of JavaScript, such as conditionals, loops, objects and methods regarding strings and arrays and intermediate and advanced concepts, such as DOM manipulation, Prototype Chain, Hoisting, Callback Queue and Promises.
...
## Sass
It contains examples of the basic functions of Sass (Syntactically Awesome StyleSheets): a CSS pre-processor with syntax advancements that is interpreted or compiled into Cascading Style Sheets (CSS) itself.
